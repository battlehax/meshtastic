...
| Raspberry Pi Model B+/2/3/4/5/400/500/Zero | Yes | Untested | Untested | Yes |
| Raspberry Pi Compute Module 2/3 | Untested | Untested | Untested | Untested |
| Raspberry Pi Compute Module 4 | Untested | Untested | Untested | Untested |
| Banana Pi | Untested | Untested | Untested | Untested |
| Luckyfox Pico | N/A | Yes | Untested | Untested |
| x86_64 PC | Untested | Untested | Untested | Yes |
