...
|Board    |MeshAdv |femtofox  |MeshMess   |MeshStick  |
| :-------------------- | :------- | :------- | :------- | :------- |
| Raspberry Pi Model A | N/A | N/A | N/A | Untested |
| Raspberry Pi Model B | N/A | N/A | N/A | Untested |
| Raspberry Pi Model B+ | Untested | Untested | Untested | Untested |
| Raspberry Pi Model 2 | Untested | Untested | Untested | Untested |
| Raspberry Pi Model 3 | Untested | Untested | Untested | Untested |
| Raspberry Pi Model 4 | Untested | Untested | Untested | Untested |
| Raspberry Pi Model 400 | Untested | Untested | Untested | Untested |
| Raspberry Pi Model 500 | Untested | Untested | Untested | Untested |
| Raspberry Pi Model Zero | Untested | Untested | Untested | Untested |
| Raspberry Pi Model Zero W| Untested | Untested | Untested | Untested |
| Raspberry Pi Model Zero 2 | Untested | Untested | Untested | Untested |
| Raspberry Pi Model Zero 2 W | Untested | Untested | Untested | Untested |
| Raspberry Pi Compute Module 2 | Untested | Untested | Untested | Untested |
| Raspberry Pi Compute Module 3 | Untested | Untested | Untested | Untested |
| Raspberry Pi Compute Module 4 | Untested | Untested | Untested | Untested |
| Banana Pi | Untested | Untested | Untested | Untested |
| Luckyfox Pico | Untested | Untested | Untested | Untested |
| x86_64 PC | Untested | Untested | Untested | Untested |
...
| Raspberry Pi Model A | N/A | N/A | N/A | Untested |
| Raspberry Pi Model B | N/A | N/A | N/A | Untested |
| Raspberry Pi Model B+/2/3/4/5/400/500/Zero | Untested | Untested | Untested | Untested |
| Raspberry Pi Compute Module 2 | Untested | Untested | Untested | Untested |
| Raspberry Pi Compute Module 3 | Untested | Untested | Untested | Untested |
| Raspberry Pi Compute Module 4 | Untested | Untested | Untested | Untested |
| Banana Pi | Untested | Untested | Untested | Untested |
